...
@section('header', 'Edit Superadmin')
@section('body')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4>Form Edit Superadmin</h4>
                </div>
                @if($errors->has('error'))
                ...
                <div class="card-body">
                    <form action="{{ route('superadmin.update', $data->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('username') is-invalid @enderror" id="username" name="username" value="{{ old('username', $data->username) }}" required>
                            @error('username')
