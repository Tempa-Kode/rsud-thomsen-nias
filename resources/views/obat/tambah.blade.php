                ...
                <div class="card-body">
                    <form action="{{ route('obat.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('merk_obat') is-invalid @enderror" id="merk_obat" name="merk_obat" value="{{ old('merk_obat') }}" required>
                            @error('merk_obat')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('aturan_pakai') is-invalid @enderror" id="aturan_pakai" name="aturan_pakai" rows="50">{{ old('aturan_pakai') }}</textarea>
                            @error('aturan_pakai')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
